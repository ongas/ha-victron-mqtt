...
class VictronSensor(VictronBaseEntity, SensorEntity):
    ...
    def _on_update_task(self, value: Any) -> None:
        ...
        if isinstance(value, str):
            ...
            _LOGGER.debug("VictronSensor: _on_update_task - Type of value: %s", type(value))
            _LOGGER.debug("VictronSensor: _on_update_task - 'Float' in SYSTEM_STATE_MAPPING: %s", "Float" in SYSTEM_STATE_MAPPING)
            _LOGGER.debug("VictronSensor: _on_update_task - 'Float' in VEBUS_INVERTER_STATE_MAPPING: %s", "Float" in VEBUS_INVERTER_STATE_MAPPING)
